...
from wtforms import StringField, SubmitField, TextAreaField, DateField, SelectField, RadioField, BooleanField, SelectMultipleField
...
class HouseHold(FlaskForm):
    ...
    properties = SelectMultipleField('Наличие собственности следующих типов (отметить все соответствующие окошки)',
